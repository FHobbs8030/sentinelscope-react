  ...
  return (
    <Card className="scan-panel">
      <div className="scan-panel__header">
        <div>
          <h3 className="scan-panel__title">Network Scan</h3>
      ...
      <div className="scan-panel__content">
        <Input label="Target" placeholder="192.168.1.1 or example.com" />

        <div className="scan-panel__options">
          <Button variant="secondary">Quick Scan</Button>

          <Button variant="secondary">Full Scan</Button>

          <Button variant="secondary">Stealth</Button>
        </div>
